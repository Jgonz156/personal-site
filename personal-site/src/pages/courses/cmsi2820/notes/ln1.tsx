  ...
  return (
    <>
      <CoursePage type="notes">
        <Sheet>Title Box: Information and it's consequences</Sheet>
        <Sheet>Topic Box: Starting from Nothing</Sheet>
        <Sheet>
          Let's start from the very beginning, no math, no knowledge, just the
          world around us and our senses...
        </Sheet>
        <Sheet>
          Philoshophical Box: What can we find? What can we begin to know?
          <Sheet>
            We might find things: cars, trees, birds, rocks, tables, phones,
            dirt, etc
          </Sheet>
          <Sheet>
            We might find properties on things: looks red, looks large, sounds
            loud, sounds far, tastes bitter, feels rough, smells bad, etc
          </Sheet>
          <Sheet>
            We might find patterns things adhere to (or patterns between
            things): gravity, social pressure, hearts "beat", seasons change,
            etc
          </Sheet>
          <Sheet>
            Things and Properties on things can be determined in a snapshot, but
            patterns arise over time
          </Sheet>
        </Sheet>
        <Sheet>
          This investigation leads to the collection of "information", discrete
          pieces of truth in the world around us. With this we can draw our
          world as the below image.
        </Sheet>
        <Sheet>
        ...
        <Sheet>
          MathJax box: Symbol one Reality which is the Captial T, symbol two
          Absurdity which is the upside down capital T, symbol three True,
          Symbol four False
        </Sheet>
        <Sheet>
        ...
        <Sheet>
          Multipe Select Question Box: Evaluate the following statement: "1 + 1
          is 3" (Select all that apply) A) True B) False C) Absurd D) Reality
        </Sheet>
        <Sheet>
          Multipe Select Question Box: Evaluate the following statement:
          "Computer's have infinite storage" (don't @ me about cloud storage
          technically allowing infinite scalability) (Select all that apply) A)
          True B) False C) Absurd D) Reality
        </Sheet>
        <Sheet>
          Multipe Select Question Box: Evaluate the following statement: "The
          car in this image is red" (Select all that apply) A) True B) False C)
          Absurd D) Reality
        </Sheet>
        <Sheet>
          Philosophical box: The last question brings up an interesting idea,
          ...
          any colors? What if you are deaf and can't hear the car? What is very
          interesting is that our disscussion is the same! The car didn't stop
          being red as a result of the perciever being colorblind, it just
          ...
          us easliy collect "truth"'s about the world around us. In the example
        ...
        <Sheet>
          Multipe Select Question Box: Evaluate the following statement: "I am
          something that is unknowable" (Select all that apply) A) True B) False
          C) Absurd D) Reality
        </Sheet>
        <Sheet>
        ...
        <Sheet>Topic Box: Systems of Logic</Sheet>
        <Sheet>
          ...
          we were using in our previous disscussion is one that feels right or
