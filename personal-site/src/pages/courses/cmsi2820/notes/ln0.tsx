  ...
  return (
    ...
    >
      ...
      <Speak>
        ...
        voice in the site. It doesn't look like much and thats on purpose since
        its meant to be the base of the site's information thats being
      ...
      <Speak>
        ...
        should be mentioned before we continue! At the very top of the page you
        find the course navigation bar. A button to access the course's homepage
        with its "one-stop-shop" table is provided in blue, a button to access
        the course's "cheat sheet" full of good information at a glance is
        provided in green, and a button to access the course's syllabus is
        provided in orange. The course navigation bar is a great way to quickly
        access the main pages of the course site.
      </Speak>
      <Speak>
      ...
      <Speak>
        The third and final component we have passed by is the topic break. It's
        a simple component that serves to separate topics from one another. This
        is useful for quickly skimming the lecture notes incase you need to find
        a specific topic quickly. It's a simple addition but it's honest work.
        Lets move onto the next component of the site, the Philosophy Break.
      </Speak>
      <TopicBreak title="Philosophy Break Component" />
      <Speak>
        The following component beneath this speak component is the philosophy
        Break component. It's job is quite simple, it just provides a way for me
        to separate out cool and thought provoking questions that arise from the
        lecture material. They have an accordion style design so that the answer
        is hidden to give you a brief moment to ponder the questions as well!
      </Speak>
      <PhilosophyBreak
        qa={[
          {
      ...
      />
      <Speak>
        An important note as a student is that nothing found in these boxes will
        ever be required for you to know and you won't ever be tested on the
        information in them either. They are simply a space to provide a small
        break from material and enjoy a small "philosophical" moment. The next
        component is for those who prefer direct definitions.
      </Speak>
      ...
      <Speak>
        ...
        ambiguity versus when I use the same word in a conversational manner. An
        example of this is the word "component" in the previous sentence. It was
        used in a conversational manner to describe the different parts of the
        site, but it could also be used in a more technical manner to describe a
        reusable piece of code in a website designed using the React framework
        (just like this site!). So I might say the{" "}
        ...
        that it makes up a useful component of my site. There it was! And that's
        all it is. A simple way to provide clarity in my speech. The next
        component is provided so that you don't have to view my bad handwriting
        in place of proper symbology!
      </Speak>
      ...
      <Speak>
        ...
        uploading an image of my handwriting, I will use the LaTeX system "under
        the hood" to display it instead. Below is some representative symbology
        that will most likely be destroyed by my handwriting.
      </Speak>
      ...
      <Speak>
        ...
        if you are wondering, they thing above it is a summation of all numbers
        from 100 to 1000 of the fraction of 10 times the square root of n
        divided by n where n is of of the number in that 100 to 1000 range. It's
        a bit of a mess but it's a good example of what we are up against here.
      </Speak>
      <Speak>
