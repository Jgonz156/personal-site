...
const S0_EXAM_BS_LINK =
  "https://brightspace.lmu.edu/d2l/le/calendar/283548/event/806055/detailsview?searchString=&year=2025&month=9&day=3&typefilterguid=8a6a9b31-7898-43b0-b61f-4ca429b0a731"
    ...
    >
      <CourseBox>
        ...
        <Speak>
          ...
          section serves only to present you with a button to go to brightspace
          to access the exam!
        </Speak>
        <Speak>
          Typically what would be here is any specific information pertaining to
          the exam that is necessary to know, such as what standards its based
          on, what topics will be covered, how many questions it has, when the
          due date and time is, and more.
        </Speak>
        <Speak>
          ...
          insane amount of your grade and they aren't made to take very long to
          complete. The goal is to be a portable, third method for gaining
          points toward a standard in the event life gets in the way of learning
          and your scores on your main homework assignment and optional just
          didn't end up how you wanted them.
        </Speak>
        <Speak>
          They are NOT collaboratory and they are NOT open note. This is because
          they are comprehension questions (These would be difficult to look up
          anyway as they will mostly pertain directly to an example we
          referenced in class). For example, if this were a course on networks
          it would include a question like this:
        </Speak>
        <MultiSelectQuestion
          ...
          choices={[
            ...
            <Speak>
              c) A data cable designed to transmit infrequent data from a car's
              backup sensor to its ECU (Engine Control Unit)
            </Speak>,
            <Speak>
        ...
        <Speak>
          ...
          description heavily implies the two answers, but the idea is the same;
          Exam questions will not require notes, calculators, or time consuming
          AI prompting to answer. Hence, why none of those things are allowed
          (If you are wondering about the problem, the answer is d and e).
        </Speak>
        <Speak>
          ...
          are always allowed to use python to "test" your choices if testing is
        ...
        <LinkButton to={S0_EXAM_BS_LINK} color="danger">
          To the Exam!
        </LinkButton>
      </CourseBox>
    </CoursePage>
