...
export default function FallCourseSchedule() {
  const schedule = [
    {
      date: DateTime.local(2025, 8, 26).startOf("day"),
      quote: "Lecture Day (LN0)",
      dayType: "lecture",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 8, 27).startOf("day"),
      quote: "Office Hours 2 PM - 5 PM",
      dayType: "office hours",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 8, 28).startOf("day"),
      quote: "Lecture Day (LN1)",
      dayType: "lecture",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 9, 1).startOf("day"),
      quote: "Labor Day!",
      dayType: "holiday",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 9, 2).startOf("day"),
      quote: "Lecture Day (LN2)",
      dayType: "lecture",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 9, 3).startOf("day"),
      quote: "Office Hours 2 PM - 5 PM",
      dayType: "office hours",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 9, 4).startOf("day"),
      quote: "Lecture Day (LN3)",
      dayType: "lecture",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 9, 5).startOf("day"),
      quote: "HW0 Due",
      dayType: "homework",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 9, 9).startOf("day"),
      quote: "Lecture Day (LN4)",
      dayType: "lecture",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 9, 10).startOf("day"),
      quote: "Office Hours 2 PM - 5 PM",
      dayType: "office hours",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 9, 11).startOf("day"),
      quote: "Lecture Day (LN5)",
      dayType: "lecture",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 9, 16).startOf("day"),
      quote: "Lecture Day (LN6)",
      dayType: "lecture",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 9, 17).startOf("day"),
      quote: "Office Hours 2 PM - 5 PM",
      dayType: "office hours",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 9, 18).startOf("day"),
    ...
    {
      date: DateTime.local(2025, 9, 24).startOf("day"),
      quote: "Office Hours 2 PM - 5 PM",
      dayType: "office hours",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 9, 25).startOf("day"),
      quote: "Lecture Day (LN8)",
      dayType: "lecture",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 9, 30).startOf("day"),
      quote: "Lecture Day (LN9)",
      dayType: "lecture",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 10, 1).startOf("day"),
      quote: "Office Hours 2 PM - 5 PM",
      dayType: "office hours",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 10, 2).startOf("day"),
    ...
    {
      date: DateTime.local(2025, 10, 7).startOf("day"),
      quote: "Lecture Day (LN11)",
      dayType: "lecture",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 10, 8).startOf("day"),
      quote: "Office Hours 2 PM - 5 PM",
      dayType: "office hours",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 10, 9).startOf("day"),
    ...
    {
      date: DateTime.local(2025, 10, 10).startOf("day"),
      quote: "Autumn Day!",
      dayType: "holiday",
      dayInfo: <></>,
    },
    ...
    {
      date: DateTime.local(2025, 10, 15).startOf("day"),
      quote: "Office Hours 2 PM - 5 PM",
      dayType: "office hours",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 10, 16).startOf("day"),
    ...
    {
      date: DateTime.local(2025, 10, 21).startOf("day"),
      quote: "Activity Day! (AC2)",
      dayType: "activity",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 10, 22).startOf("day"),
      quote: "Office Hours 2 PM - 5 PM",
      dayType: "office hours",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 10, 23).startOf("day"),
      quote: "Lecture Day (LN15)",
      dayType: "lecture",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 10, 28).startOf("day"),
      quote: "Lecture Day (LN16)",
      dayType: "lecture",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 10, 29).startOf("day"),
      quote: "Office Hours 2 PM - 5 PM",
      dayType: "office hours",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 10, 30).startOf("day"),
    ...
    {
      date: DateTime.local(2025, 11, 4).startOf("day"),
      quote: "Lecture Day (LN18)",
      dayType: "lecture",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 11, 5).startOf("day"),
      quote: "Office Hours 2 PM - 5 PM",
      dayType: "office hours",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 11, 6).startOf("day"),
      quote: "Lecture Day (LN19)",
      dayType: "lecture",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 11, 11).startOf("day"),
      quote: "Lecture Day (LN20)",
      dayType: "lecture",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 11, 12).startOf("day"),
      quote: "Office Hours 2 PM - 5 PM",
      dayType: "office hours",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 11, 13).startOf("day"),
    ...
    {
      date: DateTime.local(2025, 11, 18).startOf("day"),
      quote: "Lecture Day (LN22)",
      dayType: "lecture",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 11, 19).startOf("day"),
      quote: "Office Hours 2 PM - 5 PM",
      dayType: "office hours",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 11, 20).startOf("day"),
    ...
    {
      date: DateTime.local(2025, 11, 25).startOf("day"),
      quote:
    ...
    {
      date: DateTime.local(2025, 11, 26).startOf("day"),
      quote: "Thanksgiving!",
      dayType: "holiday",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 11, 27).startOf("day"),
      quote: "Thanksgiving!",
      dayType: "holiday",
      dayInfo: <></>,
    },
    ...
    {
      date: DateTime.local(2025, 11, 28).startOf("day"),
      quote: "Thanksgiving!",
      dayType: "holiday",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 12, 2).startOf("day"),
      quote: "Lecture Day (LN24)",
      dayType: "lecture",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 12, 3).startOf("day"),
      quote: "Office Hours 2 PM - 5 PM",
      dayType: "office hours",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 12, 4).startOf("day"),
      quote: "Activity Day! (AC3)",
      dayType: "activity",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 12, 8).startOf("day"),
      quote: "Final Release Day",
      dayType: "finals",
      dayInfo: <></>,
    },
    {
      date: DateTime.local(2025, 12, 9).startOf("day"),
      quote: "Finals Study Day 6 PM - 8 PM Pereira 207",
      dayType: "office hours",
      dayInfo: <></>,
    },
    {
    ...
    {
      date: DateTime.local(2025, 12, 12).startOf("day"),
      quote: "Final Due",
      dayType: "finals",
      dayInfo: <></>,
    },
