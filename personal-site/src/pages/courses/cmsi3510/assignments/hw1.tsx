    ...
    <>
      ...
      >
        <CourseBox>
          ...
          <Speak>
            This homework assignment is about getting used to programming in
            Rust with a small yet substantial project! The project is
            implementing a complete self contained simulation of a file system
            with a custom CLI interface!
          </Speak>
        </CourseBox>
        <CourseBox>
          <TitleBox title="Reading Section" />
          <Speak>
            As this project is quite all encompassing as it goes for
            foundational Rust features, you will need to make good use of your
            reading resources! With what truly little time we have in class, you
            will need to rely on the reading material to get you the full
            picture. The sections below give you direct and indirect help with
            organizing your thoughts about structs, memory management, and
            references in Rust.
          </Speak>
          <QuestionBox qid={"R1"}>
            In "The Rust Language Book" read, Ch 4: Understanding Ownership, Ch
            5: Using Structs to Structure Related Data, Ch 6: Enums and Pattern
          ...
          <QuestionBox qid={"W1"}>
            ...
            stamp, but if it doesn't, skip to 25:50. The previous content is
            still good, but it is mostly review of general programming concepts)
            <LinkButton
              color="success"
              to="https://youtu.be/WwkuAqObplU?t=1550"
            >
