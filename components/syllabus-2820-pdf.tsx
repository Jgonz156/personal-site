...
const courseStructure = [
  { standard: "Syllabus", assignments: "HW0 (3 pts), EX S0 (2 pts)", points: "5 (bonus)" },
  { standard: "Logic", assignments: "HW1 (100 pts)", points: "80 needed" },
  { standard: "Numbers", assignments: "HW2 (100 pts), OHW1 (20 pts)", points: "80 needed" },
  { standard: "Collections", assignments: "HW3 (100 pts), OHW2 (20 pts)", points: "80 needed" },
  { standard: "Functions", assignments: "HW4 (100 pts), OHW3 (20 pts)", points: "80 needed" },
  { standard: "Combinatorics", assignments: "HW5 (100 pts), OHW4 (20 pts)", points: "80 needed" },
  { standard: "Graph Theory", assignments: "HW6 (100 pts), OHW5 (20 pts)", points: "80 needed" },
  { standard: "Midterm", assignments: "OEX S1 (10 pts), OEX S2 (10 pts), OEX S3 (10 pts)", points: "30 Available" },
  { standard: "Final", assignments: "OHW6 (20 pts), OEX S4 (10 pts), OEX S5 (10 pts), OEX S6 (10 pts)", points: "50 Available" },
]

const assignmentPolicies = [
  { title: "Homework", description: "Each standard has a primary homework (HW) and an optional homework (OHW) targeting the previous standard. Homeworks are broken down into two major areas: written and programming. The written portion will consist of theoretical problems that are best solved on paper. The programming portion will be distributed as a Python skeleton that must be completed to pass a series of unit tests that require applying our theory into practice. All homework, optional or otherwise, is due on Fridays." },
  ...
  { title: "Exams", description: "The Midterm and Final are optional. They provide focused opportunities to boost scores in prior standards. If you have reached the point total required to pass a standard (80pts), then they are optional." },
...
const scheduleData = [
  { date: "Jan 13 (Tue)", type: "Lecture", details: "(LN0) Syllabus Day" },
  { date: "Jan 15 (Thu)", type: "Lecture", details: "(LN1) Introduction to Intuitionistic Logic" },
  ...
  { date: "Jan 20 (Tue)", type: "Lecture", details: "(LN2) Propositional Logic and Logical Connectives" },
  { date: "Jan 22 (Thu)", type: "Lecture", details: "(LN3) Logical Connectives and Natural Deduction" },
  { date: "Jan 23 (Fri)", type: "Homework", details: "HW0 Due" },
  { date: "Jan 24 (Sat)", type: "Exam", details: "Syllabus Exam Due" },
  { date: "Jan 27 (Tue)", type: "Lecture", details: "(LN4) Introduction to Type Theory" },
  { date: "Jan 29 (Thu)", type: "Lecture", details: "(LN5) Boolean Algebra and Logic" },
  { date: "Feb 3 (Tue)", type: "Lecture", details: "(LN6) Abstract Algebra and Integers" },
  { date: "Feb 5 (Thu)", type: "Lecture", details: "(LN7) Number Theory and Modular Arithmetic" },
  { date: "Feb 6 (Fri)", type: "Homework", details: "HW1 Due" },
  { date: "Feb 10 (Tue)", type: "Lecture", details: "(LN8) Tuples" },
  { date: "Feb 12 (Thu)", type: "Lecture", details: "(LN9) Sets" },
  { date: "Feb 17 (Tue)", type: "Lecture", details: "(LN10) Sets Continued" },
  { date: "Feb 19 (Thu)", type: "Lecture", details: "(LN11) First Order Logic and Relations" },
  { date: "Feb 20 (Fri)", type: "Homework", details: "HW2 Due" },
  { date: "Feb 24 (Tue)", type: "Lecture", details: "(LN12) Introduction to The Lambda Calculus" },
  { date: "Feb 26 (Thu)", type: "Lecture", details: "(LN13) Reductions, Free and Bound Variables" },
  { date: "Mar 2-6", type: "Holiday", details: "Spring Break - No Class" },
  { date: "Mar 10 (Tue)", type: "Lecture", details: "(LN14) Formal Reductions and Function Types" },
  { date: "Mar 12 (Thu)", type: "Lecture", details: "(LN15) Domain, Codomain, and Function Properties" },
  { date: "Mar 13 (Fri)", type: "Homework", details: "HW3 Due" },
  { date: "Mar 17 (Tue)", type: "Lecture", details: "(LN16) Introduction to Enumerative Combinatorics" },
  { date: "Mar 19 (Thu)", type: "Lecture", details: "(LN17) Factorials, Permutations, and Combinations" },
  { date: "Mar 22 (Sun)", type: "Exam", details: "Midterm Exam Release" },
  { date: "Mar 24 (Tue)", type: "Lecture", details: "(LN18) Pascal's Triangle and Double Counting" },
  { date: "Mar 26 (Thu)", type: "Lecture", details: "(LN19) Bijections and The Pigeonhole Principle" },
  { date: "Mar 27 (Fri)", type: "Homework", details: "HW4 Due" },
  { date: "Mar 28 (Sat)", type: "Exam", details: "Midterm Exam Due" },
  { date: "Mar 31 (Tue)", type: "Holiday", details: "Cesar Chavez Day - No Class" },
  { date: "Apr 1-3", type: "Holiday", details: "Easter Break - No Class" },
  { date: "Apr 7 (Tue)", type: "Lecture", details: "(LN20) Introduction to Graph Theory" },
  { date: "Apr 9 (Thu)", type: "Lecture", details: "(LN21) Connectedness and Common Graph Operations" },
  { date: "Apr 14 (Tue)", type: "Lecture", details: "(LN22) Special Graphs and The Traveling Salesman" },
  { date: "Apr 16 (Thu)", type: "Lecture", details: "(LN23) Forests and Minimum Spanning Trees" },
  { date: "Apr 17 (Fri)", type: "Homework", details: "HW5 Due" },
  { date: "Apr 21 (Tue)", type: "Lecture", details: "(LN24) Classical Set Theory and Axioms" },
  { date: "Apr 23 (Thu)", type: "Lecture", details: "(LN25) Contradiction and Induction" },
  { date: "Apr 28 (Tue)", type: "Lecture", details: "(LN26) Applications in AI and Pure Math" },
  { date: "Apr 30 (Thu)", type: "Lecture", details: "(LN27) Applications in Games and Systems Architecture" },
  { date: "May 1 (Fri)", type: "Homework", details: "HW6 Due" },
...
const faqData = [
  ...
  { q: "Due to the University handling the assignment of Finals during the last week of the semester, does that change how exams are administered?", a: "No, they will still be over Brightspace digitally to be taken anytime during the week, like the midterm. However, since I am required to be in those assigned rooms for 2 hours I will provide them as an open study days for help during finals week." },
  ...
  <Document>
    ...
    <Page size="LETTER" style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          This course aims to provide a rigorous foundation in the mathematics underlying Computer Science. Many of the common problems you will solve and need to represent both conceptually and in code have distinct patterns. You will develop the following core competencies:
        </Text>
    ...
    <Page size="LETTER" style={styles.page}>
      <View style={styles.section}>
        ...
        <Text style={styles.subSectionTitle}>Course Structure (480 Total Points)</Text>
        <Text style={styles.paragraph}>
          The course is divided into six standards (modules), each worth 80 points (total: 480).
        </Text>
        <View style={styles.table}>
          <View style={styles.tableHeader}>
            <Text style={[styles.tableHeaderCell, { width: 80 }]}>Standard</Text>
          ...
          {courseStructure.map((row, index) => (
            <View key={index} style={styles.tableRow}>
              <Text style={[styles.tableCell, { width: 80, fontFamily: "Helvetica-Bold" }]}>{row.standard}</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.table}>
          ...
          {scheduleData.map((row, index) => {
            ...
            return (
              <View key={index} style={styles.tableRow}>
                <Text style={[styles.tableCell, { width: 70 }]}>{row.date}</Text>
...
export async function downloadSyllabus2820Pdf() {
  const blob = await pdf(<SyllabusDocument />).toBlob()
  const url = URL.createObjectURL(blob)
  const link = document.createElement("a")
  link.href = url
  link.download = "CMSI_2820_Discrete_Mathematics_Syllabus_Spring_2026.pdf"
