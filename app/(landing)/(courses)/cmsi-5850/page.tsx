...
// Define the standards/units for CMSI-5850
// TODO: Update these to match your course structure
const STANDARDS = [
  {
    id: 0,
    name: "Syllabus",
    description: "Course syllabus and setup information",
  },
  {
    id: 1,
...
export default function CMSI5850Home() {
  ...
  const courseSpecificEvents = courseEvents.filter(
    (event) => event.courseId === "cmsi-5850"
  )
    ...
    <div className="container mx-auto p-6 max-w-7xl">
      <div className="mb-8">
        ...
        <p className="text-lg text-muted-foreground">
          Course materials organized by unit. Click on a unit to view lectures,
          homework, and exams.
        </p>
      </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-muted/50 border-b">
              ...
              <th className="text-left p-4 font-semibold w-48">Unit</th>
