...
> **Note:** The interactive graph above shows the editing capabilities. You can drag nodes to reposition them, add new nodes by clicking the "+" button, connect nodes by drawing edges, and delete elements. This feature can be enabled or disabled per graph as needed for different homework problems.
