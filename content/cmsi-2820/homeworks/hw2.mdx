...
| Optional Extra | 20      | Logic creative project                  |
| **Total**      | **100** | (**120 with extra credit**)             |

## Resources

- **Lecture Notes**: LN4 (Type Theory), LN5 (Boolean Algebra), LN6 (Integer Arithmetic), LN7 (Modular Arithmetic)
- **Textbook**: Relevant chapters on discrete mathematics and number theory
- **Office Hours**: Check course page for schedule

Think deeply about types, operations, and their properties! 🔢✨
