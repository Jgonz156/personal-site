...
| Optional Extra | 20      | Abstract algebra in your hobbies      |
| **Total**      | **100** | (**120 with extra credit**)           |

## Resources

- **Lecture Notes**: LN8 (Tuples), LN9 (Sets), LN10 (Set Operations)
- **Textbook**: Relevant chapters on discrete mathematics and collections
- **Office Hours**: Check course page for schedule

Explore the power of collections and abstract algebra! 📦✨
