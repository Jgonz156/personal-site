...
| Optional Extra | 20      | Collections experiment in your hobbies  |
| **Total**      | **100** | (**120 with extra credit**)             |

## Resources

- **Lecture Notes**: LN12 (Lambda Calculus), LN13 (Free/Bound Variables), LN14 (Conversions), LN15 (Function Properties)
- **Textbook**: Relevant chapters on lambda calculus and function theory
- **Office Hours**: Check course page for schedule

Master the lambda calculus and unlock the power of functional abstraction! λ✨
