...
| c. $\lambda x. \lambda y.\,x \cdot y$        | 3. `lambda x, y: x(y)`                                    |
| d. $\lambda x. \lambda y.\,\text{mul}\,x\,y$ | 4. `lambda x, y: x * y`                                   |
| e. unnamed function                          | 5. `lambda a: lambda b: a`                                |
| f. $\lambda x. \lambda y.\,x\,y$             | 6. `lambda b: lambda a: b`                                |
