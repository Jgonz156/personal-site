...
<QuestionBox>
**Q5:** What was the hardest part of building your serial channel? Did balls ever pile up faster than they could be processed? This is the **buffer overflow** problem—how did you handle it (or fail to handle it)?
...
<QuestionBox>
**Q7:** Your structure had to be self-supporting—you couldn't hold it during transmission. Real serial cables are passive too! But what if you could have **active repeaters** along the way? How would that change your design? This is how **RS-485** networks work over long distances.
...
<QuestionBox>
**Q12:** The cornhole board is your unreliable network—some packets get through, some don't. Real networks use **acknowledgments (ACKs)** so senders know what arrived. Did your team develop any signaling? How did receivers communicate what they still needed?
...
**Submission:** Upload your PDF to the Brightspace assignment link provided
