...
<ActivityLeaderboard data={{
  activityTitle: "Getting Folded",
  showRole: true,
  results: [
    // Add your semester data here. Example:
    // { semester: "Fall 2024", studentCount: 24, totalProduction: 47, teamSizes: [12, 12], stages: [
    //   { stageNumber: 1, stageLabel: "Sanbou-box", teams: [
    //     { role: "data", count: 12 }, { role: "task", count: 15 }
    //   ]},
    //   { stageNumber: 2, stageLabel: "Sanbou-box", teams: [
    //     { role: "task", count: 10 }, { role: "data", count: 10 }
    //   ]}
    // ]}
    {semester: "Fall 2025", studentCount: 32, totalProduction: 126, stages : [
      {stageNumber: 1, stageLabel: "Sanbou-box", durationMinutes: 20, teams: [
        {role: "data", count: 29}, {role: "task", count: 28},
      ]},
      {stageNumber: 2, stageLabel: "Sanbou-box", durationMinutes: 20, teams: [
        {role: "task", count: 33}, {role: "data", count: 36},
      ]}
    ]},
    {semester: "Spring 2025", studentCount: 4, totalProduction: 22, stages : [
      {stageNumber: 1, stageLabel: "Sanbou-box", durationMinutes: 20, teams: [
        {role: "data", count: 9},
      ]},
      {stageNumber: 2, stageLabel: "Sanbou-box", durationMinutes: 20, teams: [
    ...
    {semester: "Fall 2026", studentCount: 29, teamSizes: [16, 13], totalProduction: 140, stages : [
      {stageNumber: 1, stageLabel: "Sanbou-box", durationMinutes: 20, teams: [
        {role: "data", count: 38}, {role: "task", count: 26},
      ]},
      {stageNumber: 2, stageLabel: "Sanbou-box", durationMinutes: 20, teams: [
        {role: "task", count: 27}, {role: "data", count: 49},
      ]}
    ]},
  ],
}} />
