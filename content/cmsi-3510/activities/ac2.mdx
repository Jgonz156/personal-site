...
<ActivityLeaderboard data={{
  activityTitle: "Saved by The Schedule",
  results: [
    { semester: "Spring 2026", studentCount: 24, totalProduction: 170, teamSizes: [10, 5, 9], stages: [
      { stageNumber: 1, stageLabel: "Batch (FCFS)", durationMinutes: 11, teams: [
        { count: 35 }, { count: 27 }, { count: 38 }
      ]},
      { stageNumber: 2, stageLabel: "Interactive (RR)", durationMinutes: 11, teams: [
        { count: 21 }, { count: 16 }, { count: 33 }
      ]},
    ]},
    { semester: "Fall 2025", studentCount: 2, totalProduction: 35, teamSizes: [2], stages: [
      { stageNumber: 1, stageLabel: "Batch (FCFS)", durationMinutes: 15, teams: [
        { count: 12 }
      ]},
      { stageNumber: 2, stageLabel: "Interactive (RR)", durationMinutes: 15, teams: [
        { count: 17 }
      ]},
      { stageNumber: 3, stageLabel: "Real-Time (EDF)", durationMinutes: 15, teams: [
        { count: 10, missed: 4 }
      ]},
    ]},
  ],
