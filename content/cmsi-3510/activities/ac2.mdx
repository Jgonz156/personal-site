...
<ActivityLeaderboard data={{
  ...
  results: [
    ...
    // { semester: "Fall 2025", studentCount: 32, totalProduction: 156, teamSizes: [8, 8, 8, 8], stages: [
    //   { stageNumber: 1, stageLabel: "Batch", durationMinutes: 15, teams: [
    //     { count: 12 }, { count: 15 }, { count: 11 }, { count: 14 }
    //   ]},
    //   { stageNumber: 2, stageLabel: "Interactive", durationMinutes: 15, teams: [
    //     { count: 10 }, { count: 9 }, { count: 11 }, { count: 8 }
    //   ]},
    //   { stageNumber: 3, stageLabel: "Real-Time", durationMinutes: 15, teams: [
    //     { count: 18 }, { count: 22 }, { count: -5 }, { count: 15 }
    //   ]}
    // ]}
  ],
}} />
