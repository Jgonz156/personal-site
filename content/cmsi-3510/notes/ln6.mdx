...
1. **The History of Operating Systems** — How did we get here?
2. **Hardware Components** — The physical foundation
3. **Virtualization** — How one machine runs many programs
4. **Processes and the PCB** — The illusion of isolation
5. **Threads** — Lightweight concurrency
6. **Kernel Threads vs Green Threads** — Two models of execution
7. **Rust Examples** — Threading in practice
...
1. **Cheaper concurrency** — Creating a thread is ~100x faster than forking a process
2. **Shared memory** — Threads can communicate by sharing data structures
3. **Responsiveness** — One thread can handle UI while another does computation
4. **Parallelism** — On multi-core CPUs, threads can run truly simultaneously
...
- [Operating Systems: Three Easy Pieces](https://pages.cs.wisc.edu/~remzi/OSTEP/) — Free, excellent OS textbook

### Historical Context

- [The UNIX Time-Sharing System](https://dsf.berkeley.edu/cs262/unix.pdf) (Ritchie & Thompson, 1974) — The paper that started it all
- [Multics](https://multicians.org/) — Unix's ambitious predecessor
- [Linux Kernel Development](https://www.kernel.org/) — See how a modern OS works

### Video Resources

- [Computerphile: Processes and Threads](https://www.youtube.com/watch?v=4rLW7zg21gI) — Clear visual explanation
- [MIT 6.004: Operating Systems](https://www.youtube.com/playlist?list=PLUl4u3cNGP62WVs95MNq3dQBqY2vGOtQ2) — Full lecture series

### Rust Concurrency Deep Dives

- [Rust Atomics and Locks](https://marabos.nl/atomics/) — Free book on low-level concurrency
- [Jon Gjengset: Crust of Rust](https://www.youtube.com/playlist?list=PLqbS7AVVErFiWDOAVrPt7aYmnuuOLYvOa) — Deep Rust videos
