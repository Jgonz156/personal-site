...
- [The Rust Book: Ownership](https://doc.rust-lang.org/book/ch04-01-what-is-ownership.html) — Official guide to ownership semantics and the drop mechanism
- [The Rust Book: References and Borrowing](https://doc.rust-lang.org/book/ch04-02-references-and-borrowing.html) — Deep dive into immutable and mutable borrows
- [OSTEP Chapter 13: Address Spaces](https://pages.cs.wisc.edu/~remzi/OSTEP/) — How the OS views memory — context for why ownership matters at the systems level

### Rust Systems Programming

- [Rust by Example: Ownership and Moves](https://doc.rust-lang.org/rust-by-example/scope/move.html) — Interactive examples of ownership transfer
- [Visualizing Memory Layout](https://cheats.rs/#memory-layout) — Rust memory cheat sheet for stack, heap, and static storage
