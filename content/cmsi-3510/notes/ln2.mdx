...
- [The Rust Book: Variables and Mutability](https://doc.rust-lang.org/book/ch03-01-variables-and-mutability.html) — Official guide to Rust variables, `let`, `mut`, `const`, and `static`
- [The Rust Book: Data Types](https://doc.rust-lang.org/book/ch03-02-data-types.html) — Comprehensive reference for scalar and compound types

### Rust Systems Programming

- [Rust by Example: Primitives](https://doc.rust-lang.org/rust-by-example/primitives.html) — Interactive examples of Rust's primitive types
- [Rust by Example: Variable Bindings](https://doc.rust-lang.org/rust-by-example/variable_bindings.html) — Mutability, scope, and shadowing by example
