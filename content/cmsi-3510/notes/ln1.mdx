...
- [Python AST Documentation](https://docs.python.org/3/library/ast.html) — Explore Python's abstract syntax tree
- [Programming Language Pragmatics](https://www.cs.rochester.edu/~scott/pragmatics/) — Deep dive into language design
</LectureResources>
